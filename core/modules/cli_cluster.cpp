...
CompMap s_comps = {
    ...
    { "ceph_rgw", { 0, Q } },
    { "rbd_target", { 0, Q } },
    { "fc_link", { 0, Q, R_CONTROL | R_COMPUTE } },
    { "nova", { 0, Q } },
    { "cyborg", { 0, Q } },
...
CheckRepairItem s_services[] = {
    ...
    { S[VirtualIp], "vip,haproxy_ha,lb_backend", false },
    { S[Storage], "ceph,ceph_mon,ceph_mgr,ceph_mds,ceph_osd,ceph_rgw,rbd_target,fc_link", true, R_ALL },
