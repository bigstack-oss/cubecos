 ...
 * the epoxy venv with glance (#656). The caracal helper is still installed -- neutron
 * and manila escalate through it -- so leaving the pin behind would not fail: it
...
CONFIG_REQUIRES(glance, rabbitmq);
// extra tunings
