...
CONFIG_TUNING_STR(CUBESYS_COMPUTE_PREFIX, "cubesys.compute.prefix", TUNING_UNPUB, "Set compute node host prefix.", "", ValidateNone);
CONFIG_TUNING_STR(CUBESYS_COMPUTE_START, "cubesys.compute.start", TUNING_UNPUB, "Set compute node start IPv4 address.", "", ValidateNone);
