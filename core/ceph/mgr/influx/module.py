...
class Module(MgrModule):
    ...
    def send_to_influx(self):
        ...
        try:
            # Winson: add retention_policy and change precision to 's' 
            client.write_points(self.get_df_stats(), 's', retention_policy='def')
            client.write_points(self.get_daemon_stats(), 's', retention_policy='def')
