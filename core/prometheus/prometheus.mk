...
rootfs_install::
	$(Q)cp -f $(TOP_BLDDIR)/core/prometheus/prometheus-source/promtool $(ROOTDIR)/usr/bin/promtool
	$(Q)cp -f $(TOP_BLDDIR)/core/prometheus/prometheus-source/prometheus $(ROOTDIR)/usr/bin/prometheus
