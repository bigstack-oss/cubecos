...
# neutron, manila, barbican and designate.
#
...
# barbican hit the same thing with python-barbicanclient in #632 and designate
# with python-designateclient in #634.
#
# Nothing in hex_sdk drives it -- health_cyborg_check() only asks systemd
# whether the three units are running -- so unlike designate this is not what
# holds a health check up. It is the operator-facing cli that would go quiet.
#
