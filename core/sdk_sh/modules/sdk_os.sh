...
# Management addresses of the nodes that actually run octavia-health-manager --
# the first three compute nodes, matching CommitService. The endpoint list in
# octavia.conf must name these, not the control nodes.
os_octavia_hm_nodes()
{
