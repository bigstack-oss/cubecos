...
rootfs_install::
	$(Q)for i in {1..10} ; do timeout 30 git clone -b v3.0.0-rc1 --depth 1 https://github.com/bigstack-oss/skyline-apiserver.git $(ROOTDIR)/skyline-apiserver && break ; done
...
rootfs_install::
	...
	$(Q)for i in {1..10} ; do timeout 30 git clone -b v3.0.0-rc1 --depth 1 https://github.com/bigstack-oss/skyline-console.git $(ROOTDIR)/skyline-console && break ; done
	$(Q)# enable nvm
