...
MASAKARI_MONITORS_PATCHDIR := $(COREDIR)/masakari/$(OPENSTACK_RELEASE)_patch/masakarimonitors
MASAKARI_DASHBOARD_SRCDIR := $(ROOTDIR)$(OPENSTACK_HOME_DIR)/lib/python$(PYTHON_VER)/site-packages/masakaridashboard
MASAKARI_DASHBOARD_PATCHDIR := $(COREDIR)/masakari/$(OPENSTACK_RELEASE)_patch/masakaridashboard
